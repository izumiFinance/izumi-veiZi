...
describe("test increase unlock time", function () {
    ...
    it("modify endblock", async function () {
        ...
        await tryModifyEndBlock(veiZi, signer, '225');

        const deltaGlobalAcc3 = stringDiv(stringMul(stringMul(rewardPerBlock, '110'), q128), stakeiZiAmount);

        // phase3
        await waitUntilJustBefore(300);
        ...
        const deltaGlobalAcc4 = stringDiv(stringMul(stringMul(rewardPerBlock, '25'), q128), stakeiZiAmount);
